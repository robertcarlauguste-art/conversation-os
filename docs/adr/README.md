...
One file per decision (e.g. `001-tech-stack.md`), not one running
document — each ADR is immutable once accepted; changes get a new
ADR that supersedes it (in whole or in part).

- [001 - Technology Stack](./001-tech-stack.md)
